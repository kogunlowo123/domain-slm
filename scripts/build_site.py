...
REPOSITORY_URL: Final[str] = "https://github.com/kogunlowo123/domain-slm"
...
PAGES: Final[tuple[Page, ...]] = (
    ...
    Page(Path("docs/contamination.md"), "contamination", "Contamination", "Reference"),
    Page(Path("docs/curation.md"), "curation", "Curation and splitting", "Reference"),
    Page(Path("docs/tokenizer.md"), "tokenizer", "Tokenizer", "Reference"),
    Page(Path("docs/model.md"), "model", "The model", "Reference"),
    Page(Path("docs/reproducibility.md"), "reproducibility", "Reproducibility", "Reference"),
    Page(Path("docs/ci.md"), "ci", "Wiring it into CI", "Reference"),
...
<div class="layout">
<nav class="sidebar">
<h1><a href="index.html">aievals</a></h1>
...
def build(output: Path) -> int:
    ...
    tagline = "Evaluations that fail builds: baselines, a paired exact test, and a meta-gate."
    written = 0
    for page in PAGES:
        ...
        (output / page.output_name).write_text(
            TEMPLATE.format(
                title=html.escape("dslm" if page.slug == "index" else f"{page.title} — dslm"),
